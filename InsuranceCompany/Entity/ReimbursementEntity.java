...
@Entity
@Table(name = "reimbursementclaims")
public class ReimbursementEntity {
	...
	public ReimbursementEntity(Long id, String pname, String pemail, String pnumber, String policynumber,
			String policyname, String tpaname, String hname, String hid, String hlocation, String dname,
			String patientname, String patientage, String patientpriordisease, String nameofillness, String sumnumber,
			String relation, String hospitalbill) {
		super();
		this.id = id;
		this.pname = pname;
		this.pemail = pemail;
