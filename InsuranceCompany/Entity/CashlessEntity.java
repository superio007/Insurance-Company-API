...
@Entity
@Table(name="cashlessclaims")
public class CashlessEntity {
	...
	public CashlessEntity() {
		super();
		// TODO Auto-generated constructor stub
	}
	public CashlessEntity(Long id, String pname, String pemail, String pnumber, String policynumber, String policyname,
			String tpaname, String hname, String hid, String hlocation, String dname, String patientname,
			String patientage, String relation, String patientpriordisease, String nameofillness, String sumnumber,
			String hospitalbill) {
		super();
		this.id = id;
		this.pname = pname;
